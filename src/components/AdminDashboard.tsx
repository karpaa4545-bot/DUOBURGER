...
import { Save, Plus, Trash2, LayoutDashboard, Utensils, Settings, LogOut, ChevronRight, Upload, ImageIcon, X, Images, ShoppingCart, Clock, MapPin, Monitor, Search, CreditCard, Banknote, User, Phone, Ticket, BarChart3, PieChart, DollarSign, TrendingUp, MessageCircle, Menu, AlertTriangle, CheckCircle2 } from 'lucide-react';
                        ...
                        <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
                            ...
                            <div className="flex items-center gap-3">
                                <button
                                    ...
                                    disabled={saving}
                                    className={cn(
                                        "px-6 py-4 rounded-2xl shadow-xl font-bold flex items-center gap-2 transition-all",
                                        saving ? "bg-slate-300 text-slate-500 cursor-not-allowed" : "bg-primary text-white shadow-primary/20 hover:bg-primary/90"
                                    )}
                                >
                        ...
                        {cashierModal.show && (
                            <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
                                <div className="bg-white w-full max-w-sm rounded-[3rem] p-10 shadow-2xl animate-in fade-in zoom-in duration-300">
                                    ...
                                    <p className="text-slate-500 text-sm mb-2 font-medium">Informe o saldo inicial em dinheiro.</p>
